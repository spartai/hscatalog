...
INSERT INTO cards (name, mana, damage, hp, description, imgsrc, card_class) VALUES ('Shirvallah, the Tiger ', 25, 7, 5, 'Battlecry: Costs (1) less for each Mana you''ve spent on spells.', 'https://media.hearthpwn.com/avatars/420/149/90145.png', 'Paladin');
...
INSERT INTO cards (name, mana, damage, hp, description, imgsrc, card_class) VALUES ('Archbishop Benedictus', 7, 4, 6, 'Battlecry: Shuffle a copy of your opponent''s deck into your deck.', 'https://media.hearthpwn.com/avatars/414/848/62856.png', 'Priest');
...
INSERT INTO cards (name, mana, damage, hp, description, imgsrc, card_class) VALUES ('Vanish', 6, null, null, 'Return all minions to their owner''s hand.', 'https://media.hearthpwn.com/avatars/418/154/658.png', 'Rogue');
